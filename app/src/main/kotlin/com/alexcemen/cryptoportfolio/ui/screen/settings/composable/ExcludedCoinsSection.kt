...
@Preview(name = "ExcludedCoinsSection — view mode", showBackground = true, backgroundColor = 0xFF0A0A0A)
@Composable
private fun ExcludedCoinsSectionViewPreview() {
...
@Preview(name = "ExcludedCoinsSection — edit mode", showBackground = true, backgroundColor = 0xFF0A0A0A)
@Composable
private fun ExcludedCoinsSectionEditPreview() {
    AppTheme(themeDark = true) {
        ExcludedCoinsSection(
            excludedCoins = listOf("USDT", "USDC", "BUSD"),
            isEditing = true,
